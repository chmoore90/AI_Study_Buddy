...
class QuizResults(ctk.CTkFrame):
    ...
    def init_results(self, ed_level, subject, user_topic, quiz_data):
        ...
        self.questions_frame = ctk.CTkScrollableFrame(self, width=550, height=250, fg_color="transparent")
        ...
        reset_button.grid(row=3, column=0, padx=(300, 10), pady=5, sticky="e")
    ...
    def get_question(self, question_count, row_count, question):
        ...
        question_label.grid(row=row_count, column=0, padx=(0, 10), pady=(30, 0), sticky="nw")
        ...
        feedback_label.grid(row=row_count, column=1, padx=(5, 0), pady=(30, 0), sticky="nw")
